...
/**
 * Implementations are {@link ServingModel}s that specifically support classification
 * or regression problems.
 */
public interface ClassificationRegressionServingModel extends ServingModel {

  /**
   * @param example input features as parsed strings
   * @return prediction, as a string
   */
  String predict(String[] example);
