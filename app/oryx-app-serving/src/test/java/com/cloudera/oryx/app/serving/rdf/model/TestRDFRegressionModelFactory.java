...
public final class TestRDFRegressionModelFactory {

  private TestRDFRegressionModelFactory() {}
  ...
  public static RDFServingModel buildTestModel() {
    ...
    TerminalNode left1 = new TerminalNode("r-", new NumericPrediction(1.0, 1));
    TerminalNode right1 = new TerminalNode("r+", new NumericPrediction(10.0, 1));
    ...
    TerminalNode left2 = new TerminalNode("r-", new NumericPrediction(100.0, 1));
    TerminalNode right2 = new TerminalNode("r+", new NumericPrediction(1000.0, 1));
    ...
    overlayConfig.put("oryx.input-schema.categorical-features", "[\"0\"]");
